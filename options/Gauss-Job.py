...
HistogramPersistencySvc().OutputFile = "output/Gauss_{0}-histos.root".format(fname)
#
OutputStream("GaussTape").Output = "DATAFILE='PFN:output/Gauss_{0}.sim' TYP='POOL_ROOTTREE' OPT='RECREATE'".format(fname)
